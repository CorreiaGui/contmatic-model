...
class AuditoriaTest {
	...
	void test01_deve_aceitar_nome_criador() {
		auditoria.setNomeCriador("Guilherme Correia");
		assertEquals("Guilherme Correia", auditoria.getNomeCriador());
	}
	...
	void test04_nao_deve_aceitar_nome_criador_numeros() {
		IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class,
				() -> auditoria.setNomeCriador("Guilherme123!@"));
		assertTrue(
				thrown.getMessage().contains("Números e caracteres especiais no campo 'nome do criador' é inválido"));
	}

	@Test
	void test05_nao_deve_aceitar_nome_criador_caracteres_insuficientes() {
		IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class,
				() -> auditoria.setNomeCriador("Cj"));
	...
	void test06_nao_deve_aceitar_nome_criador_caractere_maximo() {
		IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class,
				() -> auditoria.setNomeCriador("Teestetestetestetestetestetestetestetestetesteteste"));
	...
	void test10_nao_deve_aceitar_data_criacao_passado() {
		...
		IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class,
				() -> auditoria.setDataCriacao(data1));
		assertTrue(thrown.getMessage().contains("A data de criação inserida é inválida."));
	}
	...
	void test14_nao_deve_aceitar_nome_editor_numeros() {
		IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class,
				() -> auditoria.setNomeEditor("Guilherme123!@"));
	...
	void test16_nao_deve_aceitar_nome_editor_caractere_maximo() {
		IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class,
				() -> auditoria.setNomeEditor("Teestetestetestetestetestetestetestetestetesteteste"));
