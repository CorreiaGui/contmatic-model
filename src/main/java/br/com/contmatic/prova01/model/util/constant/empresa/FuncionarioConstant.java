...
public final class FuncionarioConstant {
    ...
    public static final String MENSAGEM_ERRO_CPF_NULL = "O campo 'cpf do funcionário' é de preenchimento obrigatório.";
    ...
    public static final String MENSAGEM_ERRO_ENDERECO_NULL = "O campo 'endereço do funcionario' é de preenchimento obrigatório.";

    public static final String MENSAGEM_ERRO_ENDERECO_VAZIO = "O campo 'endereço do funcionario' é de preenchimento obrigatório.";

    public static final String MENSAGEM_ERRO_ENDERECO_TAMANHO = "O campo 'Endereço do funcionario' excedeu o limite de cadastro.";
    ...
    public static final String MENSAGEM_ERRO_TAMANHO_MINIMO_NOME = "O campo 'nome do funcionário' com menos de três caractere é inválido.";

    public static final String MENSAGEM_ERRO_TAMANHO_MINIMO_ENDERECO = "O campo 'endereco do funcionario' é de preenchimento obrigatório.";

    public static final String MENSAGEM_ERRO_TAMANHO_MINIMO_EMAIL = "O campo 'Email do funcionário' é de preenchimento obrigatório.";

    public static final String MENSAGEM_ERRO_TAMANHO_MINIMO_TELEFONE = "O campo 'Telefone do funcionário' é de preenchimento obrigatório.";

    public static final String MENSAGEM_ERRO_SETOR_NULL = "O campo 'setor do funcionário' é de preenchimento obrigatório.";

    public static final String MENSAGEM_ERRO_SETOR_TAMANHO_MAXIMO = "O campo 'setor do funcionário' excedeu o limite de cadastro permitido.";
