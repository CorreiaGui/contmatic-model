...
public final class AuditoriaConstant {
    ...
    public static final String MENSAGEM_ERRO_MENOR_IDADE = "A data inserida se refere a uma pessoa menor de idade.";

    public static final String NOME_CRIADOR_ULTRAPASSANDO_LIMITE_CARACTERES = "TESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTE";

    public static final String MENSAGEM_ERRO_NOME_CRIADOR_NULL = "O campo 'nome do criador' é de preenchimento obrigatório.";

    public static final String MENSAGEM_ERRO_NOME_CRIADOR_TAMANHO = "O campo 'nome do criador' excedeu o limite de caracteres.";
    ...
    public static final String MENSAGEM_ERRO_DATA_CRIACAO = "A data inserida no campo 'data de criação' está inválida.";
}
