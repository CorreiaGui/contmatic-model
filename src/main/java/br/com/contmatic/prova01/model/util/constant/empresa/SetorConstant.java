...
public final class SetorConstant {
    ...
    public static final int TAMANHO_MAXIMO_NOME = 40;
    ...
    public static final String MENSAGEM_ERRO_TAMANHO_MINIMO_FUNCIONARIO = "O campo 'funcionários do setor' é de preenchimento obrigatório.";
