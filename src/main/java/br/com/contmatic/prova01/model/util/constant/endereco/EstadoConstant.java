...
public final class EstadoConstant {
    ...
    public static final String MENSAGEM_ERRO_SIGLA_NULL = "O campo 'sigla do estado' é de preenchimento obrigatório.";

    public static final String MENSAGEM_ERRO_SIGLA_VAZIO = "O campo 'sigla do estado' com espaços em branco é invalido.";

    public static final String MENSAGEM_ERRO_SIGLA_TAMANHO = "O campo 'sigla do estado' permite apenas dois caracteres.";
    ...
    public static final String MENSAGEM_ERRO_NOME_NULL = "O campo 'nome do estado' é de preenchimento obrigatório.";

    public static final String MENSAGEM_ERRO_NOME_VAZIO = "O campo 'nome do estado' com espaços em branco é inválido.";

    public static final String MENSAGEM_ERRO_NOME_TAMANHO = "O campo 'nome do estado' excedeu a quantidade de caracteres.";
