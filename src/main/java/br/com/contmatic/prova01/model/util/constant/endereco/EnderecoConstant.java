...
public final class EnderecoConstant {
    ...
    public static final String MENSAGEM_ERRO_COMPLEMENTO_NULL = "O campo 'complemento do endereço' é de preenchimento obrigatório.";

    public static final String MENSAGEM_ERRO_COMPLEMENTO_VAZIO = "O campo 'complemento do endereço' com espaços em branco é inválido.";

    public static final String MENSAGEM_ERRO_COMPLEMENTO_TAMANHO = "O campo 'complemento do endereço' excedeu a quantidade de caracteres permitidos.";

    public static final String MENSAGEM_ERRO_COMPLEMENTO_TAMANHO_MINIMO = "O campo 'complemento do endereço' com menos de três caracteres é inválido.";

    public static final String MENSAGEM_ERRO_NUMERO_NULL = "O campo 'número do endereço' é de preenchimento obrigatório";
    ...
    public static final String NOME_EXCEDENDO_LIMITE_CARACTERES = "TESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTETESTE";
}
